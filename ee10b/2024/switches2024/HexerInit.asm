...
; This file contains the functions for initializing the Hexer Game clock and IO 
; port hardware. The public functions included are:
;    InitPorts  - initialize the I/O ports
;    InitTimer0 - initialize timer 0 for interrupts
;
; Revision History:
;    05/18/23  Steven Lei      initial revision, adapted from "clkinit.asm" in
;							   EXAMPLES on Glen's website.
